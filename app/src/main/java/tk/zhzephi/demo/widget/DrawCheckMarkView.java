...
import tk.zhzephi.demo.common.DisplayUtils;

/**
 * Created by HONGBO on 2017/10/11 19:14.
 */
...
public class DrawCheckMarkView extends View {
    ...
    void init() {
        ...
        //设置画笔颜色
        paint.setColor(ContextCompat.getColor(getContext(), R.color.arc_succ_color));
